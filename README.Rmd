---
title: "Introduction to R - 2022 Pitt CSD Workshop"
...
*More detailed instructions for installation
can be found here: https://rstudio-education.github.io/hopr/starting.html*

*If you prefer not to install R and Rstudio locally (or have difficulty doing so), please
create a free account with Rstudio cloud here: https://rstudio.cloud. Then
skip to step 3 and install the few needed packages*
...
![Download page for R and the R GUI](01-intro-to-R/images/paste-B40FB4F4.png){width="400"}
...
knitr::include_graphics("01-intro-to-R/images/paste-8DC0F4C7.png")
```
...
knitr::include_graphics("01-intro-to-R/images/paste-B4148C41.png")
```
...
knitr::include_graphics("01-intro-to-R/images/paste-EA4637C3.png")
```
