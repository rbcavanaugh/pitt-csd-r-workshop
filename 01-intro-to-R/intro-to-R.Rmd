...
- **Script (top left):** where you write R code and comments that you want to save for later
- **Console (bottom left):** where you run R code you just need to run once (e.g., testing something out)
- **Environment (top right):** where your R objects are saved (more on objects later)
- **Files (bottom right):** where you can view a directory of files on your computer. (you can open there from here too)
- **Plots (bottom right):** where you can view any figures you create
- **Help (bottom right):** where you can find information about r packages and functions
...
the `penguins` object is the entire dataframe. We can preview the top 6 rows as:
