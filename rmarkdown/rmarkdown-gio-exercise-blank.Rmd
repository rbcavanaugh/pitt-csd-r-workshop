...
**Task 1: Change the following code chunk so that it only displays the image and not the code**
...
**Task 2a: load the tidyverse and here packages**

**Task 2b: change warning and message chunk options to false**

*< insert code here >*

## Read in data

**Task 3: read in the demographics and "ganong" data**

*< insert code here >*

## Inline reporting

**Task 4: Replicate this paragraph from the manuscript using inline R code**
...
**Task 4a: use a function to preview the top 6 rows of the demographics data**

*< insert code here >*

**Task 4b: Calculate the 5 summary statistics noted above**

*< insert code here - use multiple chunks >*

**Task 4c: Replace the \*XXXX\* with R code to auto-populate the numbers.**
...
**Task 5: Recreating the figure**

**Task 5a: Preview the ganong data.**

-   This time, lets use a the `paged_table()` function from Rmarkdown. This only works with HTML output, but allows the reader to tab through the table. Look up the function to see how to use it. 

*< insert code here >*

**Task 5b: Print a summary of each variable in the dataset**
...
**Task 6a: Insert the sigma symbol in the italic paragraph below. Note that above, two dollar signs
...
**Task 6b: Re-factor the Continuum variable**

*< insert code here >*

**Task 6c:Summarize the ganong data**
...
**Task 6d:for each unique combination of Session, Continuum, & VOT, calculate the mean of our new response accuracy variable**

*< insert code here >*

**Task 6e: for each unique combination of Session, Continuum, & VOT, calculate the standard error of our new response accuracy variable**

*< insert code here >*

**Task 7:Create the plot**
...
**Task 8: Report your session info (info about the R software) for reproducibility**
